...
def index():
    ...
    expenses = get_all_expenses(start or None, end or None)
    ...
    return render_template('reports/index.html',
        monthly_km  = get_monthly_summary(),
        by_type     = get_expense_by_type(start or None, end or None),
...
def export_excel():
    ...
    output = export_to_excel(
        get_all_drives(start, end),
        get_all_expenses(start, end)
    )
